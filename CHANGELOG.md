...
### Features
* feat: Add release drafter configuration file ([6ccbe0a](https://github.com/tutor-contrib-aspects/commit/6ccbe0a0799590064800eb71c27de4464b845cd8))
* feat: Add manual version bump workflow ([7160c99](https://github.com/tutor-contrib-aspects/commit/7160c9993d2037e5d1d50795cf33709a73876269))
* feat: Upgrade to Superset v6 ([f3af241](https://github.com/tutor-contrib-aspects/commit/f3af2413a92dcce0a27e2e05409edec8e0aec6fa))
* feat!: Upgrade Vector to 0.50.0, fix migrations ([6763f0c](https://github.com/tutor-contrib-aspects/commit/6763f0cb510614077f3fc577d5ac631b2d311571))
* feat: Add CELERY_WORKER_EXTRA_ARGS support for Superset deployments ([92b0b69](https://github.com/tutor-contrib-aspects/commit/92b0b6932cb8c8537b8319c3e51da048b92b1546))

### Bug Fixes
* fix: fixes for superset 6 ([7b83bf0](https://github.com/tutor-contrib-aspects/commit/7b83bf091fd9c3ac0b5678156c786b72bd276d28))
* fix: update documentation links ([17d866d](https://github.com/tutor-contrib-aspects/commit/17d866dfd1ba316db5df73be8a1b56264c1e2198))
* fix: set xapi_database on EVENT_SINK_CLICKHOUSE_BACKEND_CONFIG ([8ac244d](https://github.com/tutor-contrib-aspects/commit/8ac244d33b37a887eded2809828a2eb291540da6))
* fix: remove wrong indent of the superset-row-level-security patch ([c5c9a51](https://github.com/tutor-contrib-aspects/commit/c5c9a513e626143dc6e8667b25459db67c63d37d))
* fix: remove unused metrics to fix coursename bug ([9ec1d21](https://github.com/tutor-contrib-aspects/commit/9ec1d217ab4e22f21b103f7f69ba69334d4b8e2c))
* fix: setting push to false for tag action ([b467294](https://github.com/tutor-contrib-aspects/commit/b467294f81c129cabee49aa763b8bd677187a81c))
* fix: redoing req updates + version bump ([47fde00](https://github.com/tutor-contrib-aspects/commit/47fde00497685e51a1b831eb9e52f152f210e4da))
* fix: use semantic release in release action ([979cc76](https://github.com/tutor-contrib-aspects/commit/979cc7625ebf1c2687a115eacac1958c2ad800a9))
* fix: use semantic release in release action ([1ff22df](https://github.com/tutor-contrib-aspects/commit/1ff22df7e33734e2d901aedc1f085e166f570641))
* fix: use semantic release in release action ([5bcac82](https://github.com/tutor-contrib-aspects/commit/5bcac82cf8e886194963570cd994b4d764d8e5dd))

### Maintenance & Refactoring
* chore: Update Github action package versions with SHA commit ([c1e98bc](https://github.com/tutor-contrib-aspects/commit/c1e98bc7d404d31fefef26deb46f24a6072d109b))
* chore: Upgrade Python requirements ([395658e](https://github.com/tutor-contrib-aspects/commit/395658ebad3e0e44fecd97a3a937abb99ff857b1))
* chore: Upgrade Python requirements ([42e67f8](https://github.com/tutor-contrib-aspects/commit/42e67f8de4190283e95dc567564e9e5325b5c7c9))
* chore: Upgrade Python requirements ([303e250](https://github.com/tutor-contrib-aspects/commit/303e25081b2546ff844dfb1d1f28f1bfefd2dc2c))
* chore: Update owner and lifecycle in catalog-info.yaml ([187ef62](https://github.com/tutor-contrib-aspects/commit/187ef62816a13ad8e026cd3741fd9e3505cf5f10))
* chore: Upgrade Python requirements ([00c5f52](https://github.com/tutor-contrib-aspects/commit/00c5f5243357ecb3183749c67b5c145eccee52f5))
* chore(deps): bump cryptography from 46.0.6 to 46.0.7 in /requirements ([d14b4b1](https://github.com/tutor-contrib-aspects/commit/d14b4b1c03d70de31f527c55ffde8253a06500db))
* chore(deps): bump docker/login-action from 4.0.0 to 4.1.0 ([9c20c46](https://github.com/tutor-contrib-aspects/commit/9c20c46dee13fa79de214c10dad1b9de50e416d7))
* chore: Upgrade Python requirements ([66e5698](https://github.com/tutor-contrib-aspects/commit/66e5698005a98dc6eb87264b274a5b0a507c5ffe))
* chore(deps): bump cryptography from 46.0.5 to 46.0.6 in /requirements ([a0f217a](https://github.com/tutor-contrib-aspects/commit/a0f217a2795e2b8a427cf391744cb2089b54b877))
* chore: Upgrade Python requirements ([71bdcc8](https://github.com/tutor-contrib-aspects/commit/71bdcc8fc5bbd82e4854e3a47f7b3b794bdcee05))
* chore(deps): bump actions/checkout from 5 to 6 ([edcc2f0](https://github.com/tutor-contrib-aspects/commit/edcc2f0da172ec87f657064d292c1400a2b0a962))
* chore(deps): bump docker/setup-buildx-action from 3 to 4 ([1ef8f83](https://github.com/tutor-contrib-aspects/commit/1ef8f83f496a0d22725f2f74f168fe32c8197265))
* chore(deps): bump helm/kind-action from 1.12.0 to 1.14.0 ([8c9611c](https://github.com/tutor-contrib-aspects/commit/8c9611c4f1cd4ce6424f1fed6bc670bd35e83687))
* chore: Upgrade Python requirements ([424dea8](https://github.com/tutor-contrib-aspects/commit/424dea859e96477a96539c9cef7e3eaf0b4bbb1f))
* chore: Upgrade Vector to 0.54.0 ([e5ee829](https://github.com/tutor-contrib-aspects/commit/e5ee829701f8fd5539ecb94a1a975935899a3b54))
* refactor!: Add new config for Alembic database, simplify CH grants ([7a0d3cc](https://github.com/tutor-contrib-aspects/commit/7a0d3cc3ad475dfc627aa7bd35196ec44c030da6))
* chore: Upgrade Python requirements ([1637a9c](https://github.com/tutor-contrib-aspects/commit/1637a9c4db9ba35ef6d0fcf4507e703427360676))
* chore(deps-dev): bump black from 26.3.0 to 26.3.1 in /requirements ([122bfe5](https://github.com/tutor-contrib-aspects/commit/122bfe51ad52ff65a685e4778ff20e8b90c19518))
* chore(deps): bump docker/setup-buildx-action from 3 to 4 ([40bbb1a](https://github.com/tutor-contrib-aspects/commit/40bbb1a8e8f9e24d4d7b33d3033c89444fd8f82d))
* chore(deps): bump docker/login-action from 3.7.0 to 4.0.0 ([f4e10db](https://github.com/tutor-contrib-aspects/commit/f4e10db7df90c81200f0fda8777eeb886c2af192))
* chore: Upgrade Python requirements ([9895398](https://github.com/tutor-contrib-aspects/commit/9895398dc792fdf1e329bbb5de4d9e855f5434ef))
* chore: Upgrade Python requirements ([3f27346](https://github.com/tutor-contrib-aspects/commit/3f273463aaada5c6a01331101676b64e736204ca))
* chore: Standardize queries & readme updates ([d7dab93](https://github.com/tutor-contrib-aspects/commit/d7dab93d114c9ba06e26f87a5868967ec110a5d6))
* chore(deps): bump helm/kind-action from 1.13.0 to 1.14.0 ([cb41af0](https://github.com/tutor-contrib-aspects/commit/cb41af02cdcf8c2aa825820745a741f57e2d6bf5))
* chore: Upgrade Python requirements ([54ec12f](https://github.com/tutor-contrib-aspects/commit/54ec12f9b567204b6f064866555770021d0227ef))
* chore: Upgrade Python requirements ([04e30d2](https://github.com/tutor-contrib-aspects/commit/04e30d28d7803a7c5af7e65aad31cb880c48f7ca))
* chore: preparing release 3.0.3 ([a46fdae](https://github.com/tutor-contrib-aspects/commit/a46fdae6ddd9d300a1f62d9f53ffb69a29cd397f))
* chore: Upgrade Python requirements ([ab1608f](https://github.com/tutor-contrib-aspects/commit/ab1608ff40a4fcc4f706b306c878b377b1b82836))
* chore: Upgrade Python requirements ([a1f5a47](https://github.com/tutor-contrib-aspects/commit/a1f5a47233d06853b2f92d16c6d02c773b29965d))
* chore(deps): bump docker/login-action from 3.6.0 to 3.7.0 ([d5d8653](https://github.com/tutor-contrib-aspects/commit/d5d86534d3a07ea9182d1922892dbbeaa1ca3d99))
* chore: preparing release 3.0.2 ([0ebaad5](https://github.com/tutor-contrib-aspects/commit/0ebaad57bcf8bc59ce0d1539c48f6f7364751aae))
* chore: preparing release 3.0.1 ([ebe0982](https://github.com/tutor-contrib-aspects/commit/ebe0982216651a40db54ce412044ebd8890dd108))
* chore: Upgrade Python requirements ([746dd5c](https://github.com/tutor-contrib-aspects/commit/746dd5c3a4ddf2b9319fb9f1ac38105dffdccdd4))

### Miscellaneous Updates
* Update release workflow for versioning and actions ([648f317](https://github.com/tutor-contrib-aspects/commit/648f317c7b0a7bfed3efd0b3afdb3af5004f852a))
* Enhance version bump workflow with force_bump option ([3d0327c](https://github.com/tutor-contrib-aspects/commit/3d0327ca283f24942c0bcd7665659d04abed5437))
* Update release.yaml ([9c3bf05](https://github.com/tutor-contrib-aspects/commit/9c3bf05dea80ae7de77223fa79c2f43fb1b05f3f))
* Enhance release workflow with version check on PyPI ([27ea747](https://github.com/tutor-contrib-aspects/commit/27ea74709733398cb1b7315c1b6b5f02bc5b6278))
* Extract release notes for GitHub release ([92422a7](https://github.com/tutor-contrib-aspects/commit/92422a7bd72d1155d052d56028860f71aaae97b0))
* Add input for branch, tag, or SHA in release workflow ([14a4092](https://github.com/tutor-contrib-aspects/commit/14a4092d2ee2761ac055c8c727495835a5ea6935))
* Merge pull request from saraburns1/saraburns1-patch-4-1 ([0e3c81d](https://github.com/tutor-contrib-aspects/commit/0e3c81d1f5d46f8b89b9cc21ae4f81a0e4803505))
* Enhance release workflow with manual trigger and versioning ([0cf94fb](https://github.com/tutor-contrib-aspects/commit/0cf94fb8679407bcdafc567c9648f9cd3fce6921))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-42e67f8 ([0b87d54](https://github.com/tutor-contrib-aspects/commit/0b87d5476496137c9ca91afef195914a5359307a))
* Merge pull request from openedx/repo-tools/update-code-42e67f8 ([77331f0](https://github.com/tutor-contrib-aspects/commit/77331f0b32b1abcbc99044e5ec0ae94f93b629e6))
* Merge pull request from openedx/dependabot/pip/requirements/cryptography-46.0.7 ([d45f756](https://github.com/tutor-contrib-aspects/commit/d45f756bb2ebb573f0af9a19639fe952dbe8b319))
* Merge pull request from openedx/dependabot/github_actions/docker/login-action-4.1.0 ([e42634b](https://github.com/tutor-contrib-aspects/commit/e42634bc3533d8c08cdde594e71fee5df420881a))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-0fecb77 ([8ad44d8](https://github.com/tutor-contrib-aspects/commit/8ad44d84d9846f8deaef489166a8d762ea2fffd4))
* Merge pull request from openedx/dependabot/github_actions/helm/kind-action-1.14.0 ([0fecb77](https://github.com/tutor-contrib-aspects/commit/0fecb770a5384c025acc6f518d623990ae5d8c7f))
* Merge pull request from openedx/dependabot/github_actions/docker/setup-buildx-action-4 ([baae4e9](https://github.com/tutor-contrib-aspects/commit/baae4e9a819d04eefa78ab0888302f9f5e3ef432))
* Merge pull request from openedx/dependabot/github_actions/actions/checkout-6 ([31b0a2b](https://github.com/tutor-contrib-aspects/commit/31b0a2b7468506f8d66c8981ebe9bac67994a0d4))
* Merge pull request from openedx/bmtcril/vector_bump ([59e01c8](https://github.com/tutor-contrib-aspects/commit/59e01c83d0192b82027b93a24c3f6d05a5e673ed))
* style: Fix line length ([88b9eee](https://github.com/tutor-contrib-aspects/commit/88b9eee71b723b9d59a25db3206d6d52e64cff66))
* style: Fix formatting ([8cf1c1c](https://github.com/tutor-contrib-aspects/commit/8cf1c1c7072ff610100cd48c98ddd02a7dded740))
* style: Fix line length error ([2f0da5c](https://github.com/tutor-contrib-aspects/commit/2f0da5c8ab64df8ab48cccaad76a674d905169b0))
* Merge pull request from openedx/dependabot/pip/requirements/black-26.3.1 ([205cc5b](https://github.com/tutor-contrib-aspects/commit/205cc5b53b6145967b84918c535330b780c5c0eb))
* Merge pull request from dkaliberda/dkaliberda/add-superset-worker-extraargs ([1cf8860](https://github.com/tutor-contrib-aspects/commit/1cf8860276f896af726cac9c6fc845e84a36c089))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-a46fdae ([db52b52](https://github.com/tutor-contrib-aspects/commit/db52b52c0ce8361ed3111b89baeeda946fd83571))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-b3094ea ([aa88671](https://github.com/tutor-contrib-aspects/commit/aa8867159356577f45c751a254eb67adb948cb7d))
* Merge pull request from openedx/dependabot/github_actions/docker/login-action-3.7.0 ([b3094ea](https://github.com/tutor-contrib-aspects/commit/b3094ea72a9953cfdb555f07ded56d915d8ab94e))
* Merge pull request from openedx/revert-1169-repo-tools/upgrade-python-requirements-f9ca21e ([f16eb77](https://github.com/tutor-contrib-aspects/commit/f16eb7741f5e2b8acd13cd7ed0f4314b51d82a01))
* Revert "chore: Upgrade Python requirements" ([0b112f5](https://github.com/tutor-contrib-aspects/commit/0b112f531a739d6a7e24a3f257816bbc9a0be264))
* Merge pull request from saraburns1/release_version_bump ([e627e3a](https://github.com/tutor-contrib-aspects/commit/e627e3a2000e2a5ad33af70941422ca923cd0035))
* Merge pull request from openedx/repo-tools/upgrade-python-requirements-f9ca21e ([cf70cd9](https://github.com/tutor-contrib-aspects/commit/cf70cd956f25fb09b0e00151aad12ef894d4dbc4))
...
* show default unit sidebar content when in context metrics disabled ([d2495c6](https://github.com/openedx/tutor-contrib-aspects/commit/d2495c6a92babb15816670bd920bdbac642c5452))
